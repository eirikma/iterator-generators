 ...
 *
 * This Generator gets a Yield that can hold some state between calls,
 * in order to facilitate code more similar to scala's for-comprehensions.
 */
public interface GeneratorWithState<T, S> extends Generator<T, StatefulYield<S, T>> {
